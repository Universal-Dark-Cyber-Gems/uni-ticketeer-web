  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <img
          src={details?.banner_image_url || mockDetails.image}
          alt={details?.title || mockDetails.title}
      ...
      <div className="px-5 pt-5 pb-6">
        ...
        <h2 className="text-[20px] font-medium mb-3 leading-tight text-primary-dark">
          {details?.title || mockDetails.title}
        </h2>
        ...
        <div className="flex items-center gap-2 mb-2 text-primary-dark">
          ...
          <span className="text-sm">
            {formatDay(details?.start_date, "ddd, DD MMM") || mockDetails.date}
            <span className="mx-2 text-gray-300">•</span>
            {formatTime(details?.start_time) || mockDetails.time}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 mb-5 text-primary-dark">
          ...
          <span className="text-[16px]">
            {details?.venue || mockDetails.location}
          </span>
        </div>
