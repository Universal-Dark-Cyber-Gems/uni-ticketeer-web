    ...
    return(
        <Link to={"/dashboard"} className='flex items-center justify-center md:w-[40%] h-[150px] relative border-[1px] border-primary-dark m-2'>
            <img 
                ...
                alt='ticket banner' 
            />
            <div className='p-2 border-l-[3px] border-dashed border-primary-dark flex flex-col justify-between items-center absolute h-[100%] bg-gradient-to-r from-white/70 to-white/90 right-0 bg-transparent'>
