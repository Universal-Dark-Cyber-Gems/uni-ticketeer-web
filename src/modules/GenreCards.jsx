...
export default function GenreCards({icon, text}){
    return(
        <div className='flex flex-col md:flex-row w-[55.5px] md:w-auto items-center gap-2 text-[12px] md:text-[24px]'>
            <div 
                style={{
            ...
            >
                {icon}
                {/* <TbMicrophone2 size={25} className='text-primary-orange' /> */}
            </div>
