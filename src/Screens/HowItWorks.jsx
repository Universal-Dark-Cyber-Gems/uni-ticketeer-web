        ...
        <>
                ...
                <div className="bg-[#000]/70 py-4">
                    <Section>
                        ...
                        <div className="md:w-[70%] m-auto py-4 my-2">
                            <p className='text-white text-center text-[28px] md:text-[80px] leading-[1.2]'>Find Your <span className='text-primary-orange'>Event</span> And Get A Ticket</p>
            ...
            <Section>
                <div className="min-h-[100vh] md:pt-6">
                    <div className="text-[24px] md:text-[36px] text-center font-medium text-primary-dark my-4">
                        How It Works
                    </div>
