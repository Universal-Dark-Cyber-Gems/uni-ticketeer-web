        ...
        <>
            <div className="md:flex">
                <div className="w-[25%] hidden md:flex flex-col justify-center items-center h-[100vh] bg-primary-dark fixed">
                    <h2 className="text-white text-xl absolute top-10 left-10 font-bold"><Link to={"/"}>Uniticketeer</Link></h2>
                ...
                <div className="w-full md:w-[80%] min-h-[100vh] ml-auto py-4 bg-[#EEE] items-center justify-center flex">
                    <h2 className="text-primary-dark absolute md:hidden top-5 left-10 text-xl font-bold"><Link to={"/"}>Uniticketeer</Link></h2>
                    <Outlet />
                </div>
            </div>
        </>
