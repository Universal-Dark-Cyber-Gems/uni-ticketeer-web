    ...
    return(
        <>
            <div className='py-4 my-4'>
                <div className='w-[90%] p-4 relative m-auto border-2 border-primary-dark rounded-xl'>
                    ...
                    <div>
                        <div className='flex flex-wrap justify-end items-center gap-4'>
                            ...
                            <div className='cursor-pointer border-[1px] text-[14px] border-red-500 p-2 font-medium rounded-full text-white bg-red-500'>
                                Delete Event
                            </div>
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <div>
                                <div className="flex justify-between mb-4">
                                    ...
                                    <div className="text-sm text-primary-dark underline cursor-pointer hover:text-primary-orange"> + Add more Tickets</div>
                                </div>
            ...
            <div className='p-2 text-primary-dark'>
                <div className='flex justify-between p-2'>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='font-medium text-md text-center'>{details?.ticket_quantitiy || "no limit"}</div> 
                    </div>
                </div>
